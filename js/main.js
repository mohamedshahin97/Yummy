...
function displayHomeMeals() {  
    ...
    for (let i = 0; i < mealsArray.length; i++) {
        ...
        <div onclick="displayMeal('${mealsArray[i].idMeal}')" class="mealCard rounded-2">
    ...
    document.getElementById('rowHomeMeals').innerHTML = cartona;
}
...
async function displayMeal(mealId) {
    $('#loading').show();
    // console.log(mealId);
    document.getElementById('allMeals').classList.add('d-none');
...
// function linksAnimationHide() {
//     $('.sideBarLinks').addClass('animate__animated animate__fadeInBottomLeft animate__delay-0.3s');
// }